...
enum alt_keycodes {
    ...
    MD_BOOT,               //Restart into bootloader after hold ti˜meout
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LT(1, KC_ESC), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_PGUP, \
    ...
    [1] = LAYOUT(
        ...
        _______, RGB_TOG, _______, _______, _______, MD_BOOT, TG_NKRO, _______, _______, _______, KC_LOCK, _______,          _______, KC_VOLD, \
